    ...
    public void start(){
        ...
        scheduleThread = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                int preReadCount = (ScheduleConfiguration.getAdminConfig().getTriggerPoolFastMax() +
                        ScheduleConfiguration.getAdminConfig().getTriggerPoolSlowMax()) * 20;
                ...
                while (!scheduleThreadToStop) {
                    ...
                    try {
                        ...
                        conn = ScheduleConfiguration.getAdminConfig().getDataSource().getConnection();
                        ...
                        List<JobInfo> scheduleList = ScheduleConfiguration.getAdminConfig().getXxlJobInfoDao().
                        ...
                        if (scheduleList!=null && scheduleList.size()>0) {
                            ...
                            for (JobInfo jobInfo: scheduleList) {
                                ScheduleConfiguration.getAdminConfig().getXxlJobInfoDao().scheduleUpdate(jobInfo);
                            }
