...
public class TaskJobContext {
    ...
    public TaskJobContext(long jobId, String jobParam, String jobLogFileName, int shardIndex, int shardTotal) {
        this.jobId = jobId;
    ...
    private static InheritableThreadLocal<TaskJobContext> contextHolder = new InheritableThreadLocal<TaskJobContext>(); // support for child thread of job handler)

    public static void setTaskJobContext(TaskJobContext xxlJobContext){
        contextHolder.set(xxlJobContext);
    }

    public static TaskJobContext getTaskJobContext(){
