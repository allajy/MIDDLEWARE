...
import com.bxc.assemble.dynamicTask.toolkit.IpUtil;
import com.bxc.assemble.dynamicTask.toolkit.ThrowableUtil;
...
public class TaskJobTrigger {
    ...
    public static void trigger(int jobId,
        ...
        // load data
        JobInfo jobInfo = ScheduleConfiguration.getAdminConfig().getXxlJobInfoDao().loadById(jobId);
        if (jobInfo == null) {
        ...
        JobGroup group = ScheduleConfiguration.getAdminConfig().getXxlJobGroupDao().load(jobInfo.getJobGroup());
    ...
    private static void processTrigger(JobGroup group, JobInfo jobInfo, int finalFailRetryCount, TriggerTypeEnum triggerType, int index, int total){
        ...
        ScheduleConfiguration.getAdminConfig().getXxlJobLogDao().save(jobLog);
...
//            triggerResult = new ReturnT<String>(ReturnT.FAIL_CODE, null);
        ...
        ScheduleConfiguration.getAdminConfig().getXxlJobLogDao().updateTriggerInfo(jobLog);
