package com.bxc.assemble.dynamicTask.serv;

import com.bxc.assemble.dynamicTask.dao.JobUserDao;
import com.bxc.assemble.dynamicTask.domain.ReturnT;
import com.bxc.assemble.dynamicTask.model.JobUser;
import com.bxc.assemble.dynamicTask.toolkit.CookieUtil;
import com.bxc.assemble.dynamicTask.toolkit.I18nUtil;
import com.bxc.assemble.dynamicTask.toolkit.JacksonUtil;
...
public class LoginService {
    ...
    public ReturnT<String> login(HttpServletRequest request, HttpServletResponse response, String username, String password, boolean ifRemember){
        ...
        // valid passowrd
        JobUser xxlJobUser = xxlJobUserDao.loadByUserName(username);
        if (xxlJobUser == null) {
