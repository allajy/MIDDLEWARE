 ...
 */
package com.bxc.assemble.dubbo3.comp.api;
...
public class APIConsumerBootstrap {
    ...
    public static void main(String[] args){
        //DubboTest
        BaseProcessService baseProcessService = APIConsumerBootstrap.reference(BaseProcessService.class);
        RpcContext.getContext().setAttachment("param","Hello , I am Li ");
