 ...
 */
package com.bxc.assemble.dubbo3.comp.multi;
 ...
 */
@Slf4j
public class MultiConsumerBootstrap2 {
    ...
    private static String zookeeperPort1 = System.getProperty("zookeeper.port",
            "2181");
    ...
    public static <T> T reference(Class<T> clazz){
        try {
            ...
            reference.setRegistries(Lists.newArrayList(new RegistryConfig(
                    "zookeeper://" + zookeeperHost + ":" + zookeeperPort1),
                    new RegistryConfig(
                            "zookeeper://" + zookeeperHost + ":" + zookeeperPort2)));
...
//            reference.setCache("jcache");
    ...
    public static void main(String[] args){
        //DubboTest
        BaseProcessService baseProcessService = MultiConsumerBootstrap2.reference(BaseProcessService.class);
        ...
        for(int i=0;i<10;i++){
            ...
            System.out.println(baseProcessService.process("测试功能实现控制!"));
