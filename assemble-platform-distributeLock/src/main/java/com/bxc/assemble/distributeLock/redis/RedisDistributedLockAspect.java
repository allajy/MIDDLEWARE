package com.bxc.assemble.distributeLock.redis;

import com.bxc.assemble.distributeLock.base.LockCategory;
import com.bxc.assemble.distributeLock.error.RedisDistributedLockException;
...
public class RedisDistributedLockAspect {
    ...
    @Around("execution(public * *(..)) && @annotation(com.bxc.assemble.distributeLock.redis.RedisDistributedLock)")
